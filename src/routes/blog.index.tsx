    ...
    <div>
      <section className="bg-navy py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <h1 className="font-heading text-4xl md:text-5xl font-bold text-navy-foreground">Health Blog</h1>
          <p className="text-lg text-navy-foreground/70 mt-4">Expert medical advice from our doctors</p>
        </div>
      </section>
