...
export function WhatsAppButton() {
  return (
    ...
    >
      {/* Glass ring effect */}
      <span className="absolute inset-[-3px] rounded-full border-2 border-cta/30 animate-pulse-whatsapp pointer-events-none" />
      ...
      <span className="absolute bottom-full right-0 mb-3 px-3 py-1.5 bg-foreground text-background text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap pointer-events-none shadow-lg translate-y-1 group-hover:translate-y-0">
        Chat with us
      </span>
    </button>
  );
